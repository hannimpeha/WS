...
public class GraphVizExe {
    ...
    public GraphVizExe() {
        if (GraphVizExe.osName.contains("Windows")) {
            this.tempDir = "c:/temp";
            this.executable = "c:/Program Files (x86)/Graphviz 2.28/bin/dot.exe";
        } else if (GraphVizExe.osName.equals("MacOSX")) {
            this.tempDir = "/tmp";
            this.executable = "/usr/local/bin/dot";
        } else if (GraphVizExe.osName.equals("Linux")) {
            this.tempDir = "/tmp";
    ...
    public GraphVizExe(String executable, String tempDir) {
